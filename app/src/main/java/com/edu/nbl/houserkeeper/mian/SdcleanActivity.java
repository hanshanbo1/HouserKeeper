...
import com.edu.nbl.houserkeeper.adapter.RubbishFileAdapter;
import com.edu.nbl.houserkeeper.biz.DbClearPathManager;
import com.edu.nbl.houserkeeper.biz.FileManager;
import com.edu.nbl.houserkeeper.entity.RubbishFileInfo;
...
public class SdcleanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initActiongBar(title, R.drawable.btn_homeasup_default, -1, clickListener);
        //
        ...
        btn_clean = (Button) findViewById(R.id.btn_clearrubbish);//一键清理
    ...
    private void asyncLoaddata() throws IOException {
        ...
        final ArrayList<RubbishFileInfo> rubbishFileInfos = DbClearPathManager.getPhoneRubbishfile(getApplicationContext());//拷贝到手机中
    ...
    private CompoundButton.OnCheckedChangeListener checkedChangeListener = new CompoundButton.OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
            List<RubbishFileInfo> rubbishFileInfos = rubbishFileAdapter.getDatasFromAdapter();//获取适配器里所有的数据
